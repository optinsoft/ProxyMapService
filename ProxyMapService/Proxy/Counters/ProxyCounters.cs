...
namespace ProxyMapService.Proxy.Counters
{
    public class ProxyCounters
    {
        ...
        public HttpHeadersLogger? HttpRequestHeadersLogger { get; set; }
        public HttpHeadersLogger? HttpResponseHeadersLogger { get; set; }
        public HttpCompletionLogger? HttpCompletionLogger { get; set; }
        public HttpBodyLogger? HttpRequestBodyLogger { get; set; }
        public HttpBodyLogger? HttpResponseBodyLogger { get; set; }
